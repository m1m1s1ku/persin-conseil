			...
			<div id="persin-app" class="app">
				...
				<footer class="grid" @click="${this._hideMobileMenu}">
					<div class="social-container">
						...
						<a rel="noopener" href="https://facebook.com/PersinConseil" target="_blank">
							<iron-icon class="social" icon="inline:facebook" role="img" aria-label="Facebook"></iron-icon>
						</a>
						<a rel="noopener" href="https://twitter.com/PersinConseil" target="_blank">
							<iron-icon class="social" icon="inline:linkedin" role="img" aria-label="Linkedin"></iron-icon>
						</a>
						<a rel="noopener" href="https://fr.linkedin.com/in/thibautmatias" target="_blank">
